...
const DEFAULT_PLAN = {
  FBA: { name: 'Full Body A', day: 1, exercises: [
    ...
    { id: 'machine-row', name: 'Chest-supported Row (machine)', sets: 3, reps: '8-12', rest: 120, suggest: 'Start light — find a weight for 8-12 clean reps (~25-30 kg stack)', cue: 'Chest GLUED to pad the whole set. Pull handles to lower ribs, squeeze blades 1s, slow return. No yanking with the arms. Machine busy? Seated cable row hits the same muscles.', video: yt('chest supported machine row form') },
